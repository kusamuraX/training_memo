                ...
                return Positioned(
                  ...
                  child: Row(
                    ...
                    children: events.map((e) {
                      return Container(
                        decoration: BoxDecoration(color: PartsColors.getColor((e as EventModel).partsId), shape: BoxShape.circle),
                ...
                if (e is EventModel) {
                  return Container(
                    decoration: BoxDecoration(
                      border: Border.all(width: 1, color: PartsColors.getColor(e.partsId)),
